...
class XmlCompareTests(unittest.TestCase):
    ...
    doc6 = '<doc><b><c attr1="1">world</c></b><a><c>world</c></a></doc>'
    doc7 = '<doc><b><c attr1="1">world</c></b><b><c>world</c></b></doc>'
    doc8 = '<doc><b><c>world</c></b><b><c attr1="1">world</c></b></doc>'
    ...
    soap_doc1 = '''<?xml version="1.0" encoding="UTF-8"?>
      ...
      <soapenv:Body><UpdateDateTime xmlns="urn:vim25"><_this
      type="HostDateTimeSystem">dateTimeSystem-14</_this><dateTime
      >2014-08-19T04:29:36.070918-04:00</dateTime></UpdateDateTime
      ></soapenv:Body>
    ...
    soap_doc2 = '''<?xml version="1.0" encoding="UTF-8"?>
      ...
      <soapenv:Body><UpdateDateTime
       xmlns="urn:vim25"><_this
       type="HostDateTimeSystem"
       >dateTimeSystem-14</_this><dateTime
       >2014-08-19T04:29:36.070918-04:00</dateTime></UpdateDateTime
       ></soapenv:Body>
    ...
    def test_deep_compare(self):
        ...
        self.assertFalse(xml_compare.full_compare(XmlCompareTests.doc4,
                                                  XmlCompareTests.doc6))

    @unittest.skip('skipping xml document deep comparison')
    def test_deep_compare_mixed_order(self):
        # TODO (hartsock): fix xml compare utility to pass this test
        # there is a problem comparing documents that are logically
        # identical lists but who's element order are different. This
        # poses a real problem in comparisons.
        self.assertTrue(xml_compare.full_compare(XmlCompareTests.doc7,
                                                 XmlCompareTests.doc8))
